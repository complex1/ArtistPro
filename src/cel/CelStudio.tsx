...
type Settings = RestoreOptions & TraceOptions & { exportScale: number; inkEnabled: boolean }
      ...
      {!source ? (
        <main className="cel-empty">
          ...
          <p className="studio-lede">
            ...
            outlines, JPEG mush. Gradients and photos turn into bands. Nothing
            leaves this browser.
          </p>
          <button
            type="button"
